...
```ts
import { useCreateOrder, useUpdateProductPrice, useGetUserSubscriptions, useListServiceRequests } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetUserSubscriptions(getUserSubscriptionsVars);

const { data, isPending, isSuccess, isError, error } = useListServiceRequests();
...
```js
import { createOrder, updateProductPrice, getUserSubscriptions, listServiceRequests } from '@dataconnect/generated';
