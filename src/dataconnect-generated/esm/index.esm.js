...
export function getUserSubscriptions(dcOrVars, varsOrOptions, options) {
...
export const listServiceRequestsRef = (dc) => {
...
export function listServiceRequests(dcOrOptions, options) {
