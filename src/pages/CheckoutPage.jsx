...
const PAYMENT_METHODS = [
  {
    id: 'instapay',
    label: 'InstaPay',
    desc: 'تحويل فوري على الرقم: 01099599558',
    icon: '⚡',
    info: 'حوّل المبلغ على InstaPay ثم ارفع صورة الإيصال',
    account: '01099599558 (إنستاباي)',
    manual: true,
  },
  {
    id: 'vodafone',
    label: 'فودافون كاش',
    desc: 'تحويل على الرقم: 01099599558',
    icon: '📱',
    info: 'حوّل المبلغ على فودافون كاش ثم ارفع صورة الإيصال',
    account: '01099599558 (فودافون كاش)',
    manual: true,
  },
  {
    id: 'whatsapp',
...
export default function CheckoutPage() {
  ...
  const processImageFile = (file) => {
    ...
    if (file.size > 5 * 1024 * 1024) {
      setReceiptError('حجم الصورة يجب أن يكون أقل من 5MB');
      return;
    }
    setReceiptError('');
