...
const steps = [
  { label: 'تم استلام الطلب', desc: 'تم إرسال طلبك بنجاح وجاري مراجعة الطلب' },
  { label: 'تأكيد عملية الدفع', desc: 'التحقق من إيصال التحويل أو الدفع الإلكتروني' },
  { label: 'تجهيز وتفعيل الاشتراك', desc: 'توليد مفاتيح الترخيص أو إعداد الحساب الرقمي' },
  { label: 'نشط - جاهز للاستخدام', desc: 'تم تفعيل الاشتراك وتوفير تفاصيل الدخول أدناه' }
];
          ...
          <div style={{
            ...
            {viewOrder.status === 'pending' && (
              <div style={{
                ...
                ⏳ <strong>جاري تفعيل اشتراكك رقمياً...</strong> سنقوم بالتحقق وتوفير معلومات التفعيل (مثل مفاتيح الترخيص أو بيانات الدخول للبرنامج) وإرسالها أيضاً عبر بريدك الإلكتروني والواتساب المسجل خلال دقائق معدودة.
              </div>
            )}
