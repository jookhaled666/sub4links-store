...
import { Plus, Edit2, Trash2, ToggleLeft, ToggleRight, X, Save, Search } from 'lucide-react';
...
export default function AdminProducts() {
  const { managedProducts, addProduct, updateProduct, deleteProduct, toggleStock } = useOrders();
    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          ...
          <p style={{ color: 'var(--fg-muted)', fontSize: '0.875rem' }}>{managedProducts.length} منتج / خدمة</p>
        </div>
              ...
              <tr key={product.id}>
                <td>
                  <div className="admin-product-cell">
                    <img src={product.image} alt={product.name} className="admin-product-thumb" onError={e => { e.target.src = '/images/products/placeholder.jpg'; }} />
                    <div>
          ...
          <div className="admin-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="admin-modal__fields">
              ...
              <div className="admin-modal__field">
                ...
                <input value={form.image} onChange={e => upd('image', e.target.value)} placeholder="/images/products/..." />
              </div>
              <div className="admin-modal__field">
                <label>الوصف</label>
